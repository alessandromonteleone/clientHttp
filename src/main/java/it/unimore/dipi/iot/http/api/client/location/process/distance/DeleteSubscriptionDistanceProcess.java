...
import it.unimore.dipi.iot.http.api.client.location.process.areaCircle.DeleteSubscriptionAreaCircleProcess;
...
public class DeleteSubscriptionDistanceProcess {
    ...
    public static void main(String[] args) {
        ...
        String subscriptionId = "5"; // si trova in resourceURL nella riposta alla post
