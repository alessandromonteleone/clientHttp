...
public class DeleteZoneStatusSubscriptionProcess {
        final static protected Logger logger = LoggerFactory.getLogger(DeleteZoneStatusSubscriptionProcess.class);

        private final CloseableHttpClient httpClient;
        private final String baseUrl;

        public DeleteZoneStatusSubscriptionProcess(String baseUrl) {
        ...
        public void DeleteSubscription(String subscriptionId) {
            ...
            try {
                ...
                String targetUrl = String.format("%s/subscriptions/zoneStatus/%s", this.baseUrl, subscriptionId);
        ...
        public static void main(String[] args) {
            ...
            DeleteZoneStatusSubscriptionProcess deleteZoneStatusSubscriptionProcess = new DeleteZoneStatusSubscriptionProcess(baseUrl);

            //DELETE /subscriptions/zoneStatus/{subscriptionId}
            deleteZoneStatusSubscriptionProcess.DeleteSubscription(subscriptionId);
        }
}