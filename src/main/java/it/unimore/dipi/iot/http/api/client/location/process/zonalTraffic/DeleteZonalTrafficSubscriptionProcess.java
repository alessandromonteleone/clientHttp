...
public class DeleteZonalTrafficSubscriptionProcess {

    final static protected Logger logger = LoggerFactory.getLogger(DeleteZonalTrafficSubscriptionProcess.class);

    private final CloseableHttpClient httpClient;
    private final String baseUrl;

    public DeleteZonalTrafficSubscriptionProcess(String baseUrl) {
