...
import java.util.Optional;
    ...
    public class DeleteAppMobilitySubscriptionProcess {

        final static protected Logger logger = LoggerFactory.getLogger(DeleteAppMobilitySubscriptionProcess.class);

        private final CloseableHttpClient httpClient;
        private final String baseUrl;

        public DeleteAppMobilitySubscriptionProcess(String baseUrl) {
        ...
        public static void main(String[] args) {
            ...
            deleteAppMobilityServicesProcess.deleteSubscription(subscriptionId);
