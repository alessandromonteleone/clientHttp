...
import it.unimore.dipi.iot.http.api.client.applicationSupport.model.request.PostConfirmTerminationRequestDescriptor;
...
public class PostConfirmTerminationProcess {

    final static protected Logger logger = LoggerFactory.getLogger(PostConfirmTerminationProcess.class);

    private final CloseableHttpClient httpClient;
    private final ObjectMapper objectMapper;
    private final String baseUrl;

    public PostConfirmTerminationProcess(String baseUrl) {
        this.baseUrl = baseUrl;
        this.objectMapper = new ObjectMapper();
        this.httpClient = HttpClients.custom().build();
    }

    public void confirmTermination(PostConfirmTerminationRequestDescriptor confirmTerminationRequestDescriptor, String appInstanceId) {
        try{
            ...
            String targetUrl = String.format("%s/applications/%s/confirm_termination", this.baseUrl, appInstanceId);

            logger.info("Target Url: {}", targetUrl);

            String jsonBody = this.objectMapper.writeValueAsString(confirmTerminationRequestDescriptor);
    ...
    public static void main(String[] args) {
        ...
        PostConfirmTerminationRequestDescriptor requestDescriptor = new PostConfirmTerminationRequestDescriptor();
        requestDescriptor.setOperationAction("TERMINATING");

        confirmTerminationProcess.confirmTermination(requestDescriptor,appIstanceId );
